...
- **Story:** As a developer, I want to save a repeatable process as a step-by-step workflow so that I run it the same way every time
  - **Feature:** Create workflows with steps and tasks (CRUD)
- **Story:** As a developer, I want to check off tasks as I work so that I always know what's done and what's left
  - **Feature:** Task toggle + progress
- **Story:** As a developer, I want to pin my most-used workflows so that I can reach them instantly
  - **Feature:** Pin / favorite
- **Story:** As a developer, I want workflows sorted by most recently worked on so that I can pick up where I left off
  - **Feature:** `updated_at` sorting
- **Story:** As a developer, I want to import a repo's recent commits as workflow steps so that I can turn real activity into a process
  - **Feature:** GitHub API integration
- **Story:** As a developer, I want my workflows private to my account so that other users can't see them
  - **Feature:** Auth + per-user scoping

### Exercise 4: Feature prioritization + MVP

**Must Have (MVP)**
- Create/edit workflows with steps and tasks
- Check off tasks + see progress
- User accounts + per-user scoping

**Nice to Have**
- Pin workflows
- Sort by recently worked on
- Reorder steps (`position`)

**Later**
- GitHub commit import
- HTTP log visualizer panel
